...
int main(void)
{
    ...
    do
    {
        ...
        i = get_long("What is our card number?\n ");
    }
    while (i < 0);

    // sum every other digit starting w/ the last
    ...
    if (sum % 10 == 0)
    {
        if ((i >= 340000000000000 && i < 350000000000000)
            || (i >= 370000000000000 && i < 380000000000000))
        {
            printf("AMEX\n");
        }
        ...
        else if ((i >= 4000000000000 && i < 5000000000000)
                 || (i >= 4000000000000000 && i < 5000000000000000))
        {
            printf("VISA\n");
        }
        else
